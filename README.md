...
```bash
npm install --save-dev babel-eslint eslint@2.7.0 eslint-config-richardkall
```
...
```bash
npm install --save-dev babel-eslint eslint@2.7.0 eslint-plugin-react@4.3.0 eslint-config-richardkall
```
...
```bash
npm install --save-dev eslint@2.7.0 eslint-config-richardkall
```
